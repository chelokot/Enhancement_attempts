...
## Example usage on a image directly: python demo.py --task real_denoising --input_dir './demo/degraded/шум10.png' --result_dir './demo/restored/'
## Example usage with tile option on a large image: python demo.py --task real_denoising --input_dir './demo/degraded/шум10.png' --result_dir './demo/restored/' --tile 720 --tile_overlap 32
##--------------------------------------------------------------
